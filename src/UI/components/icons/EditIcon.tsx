...
export const EditIcon = (props: IIconProps) => <div className="h-5 w-5 flex justify-center items-center border rounded-full border-black bg-white" onClick={props.onClick}>
