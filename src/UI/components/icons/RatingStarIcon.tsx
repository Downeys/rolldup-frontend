...
export const RatingStarIcon = (props: IIconProps) => <svg xmlns="http://www.w3.org/2000/svg" className={props.styling || "h-6 w-6"} fill="none" viewBox="0 0 24 24" stroke={window.matchMedia('(prefers-color-scheme: dark)').matches ? "white" : "currentColor"}>
